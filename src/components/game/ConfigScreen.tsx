...
const ConfigScreen: React.FC<ConfigScreenProps> = ({ onStart }) => {
  ...
  return (
    <>
      <div className="relative w-full max-w-xl mx-auto p-8 bg-gray-800 rounded-xl shadow-lg border border-gray-700">
        <button
        ...
        <h1 className="text-3xl font-bold text-center text-white mb-6 px-12">
          タイピングゲーム設定
        </h1>
